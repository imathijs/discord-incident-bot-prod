module.exports = {
  ...
  INCIDENT_REPORT_SELF: 'incident_report_self',
  INCIDENT_REPORT_OTHER: 'incident_report_other',
  INCIDENT_REPORTER_SELECT: 'incident_reporter_select',
  ...
  STEWARD_CLOSE_INCIDENT: 'steward_close_incident',
  ...
  STEWARD_CLOSE_REASON_MODAL: 'steward_close_reason_modal',
  DM_ACTIVE_INCIDENT_SELECT: 'dm_active_incident_select',
  DM_ACTION_EVIDENCE_PREFIX: 'dm_action_evidence',
  DM_ACTION_STEWARD_PREFIX: 'dm_action_steward',
